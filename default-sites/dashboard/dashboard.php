...
<h2>Primary Vagrant Tools</h2>
	...
	<ul>
		...
		<li><a href="http://mailhog.pv:8025" target="_blank">Collect email with MailHog</a></li>
	</ul>
...
<h2>Development Sites</h2>
	...
	<ul>
		...
		<li><a href="http://legacy.wordpress.pv" target="_blank">WordPress Legacy Branch (old version - 4.7.x)</a></li>
		<li><a href="http://stable.wordpress.pv" target="_blank">WordPress Stable Branch (current version - 4.8.x)</a></li>
